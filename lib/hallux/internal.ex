defmodule Hallux.Internal do
  ...
  defmodule Empty do
    ...
    defimpl Hallux.Measured do
      def size(_empty, z, _measure, _reduce), do: z
    end
  end
  ...
  defmodule Single do
    ...
    defimpl Hallux.Measured do
      ...
      def size(%Single{v: v}, z, measure, reduce), do: Measured.size(v, z, measure, reduce)
    end
  end
  ...
  defp app3(
         %__MODULE__.Deep{pr: pr1, m: m1, sf: sf1},
         ts,
    ...
    deep(
      ...
      app3(
        m1,
        Node.to_nodes(lsf1 ++ ts ++ lpr2, zero, measure, reduce),
        m2,
        zero,
        measure,
        reduce
