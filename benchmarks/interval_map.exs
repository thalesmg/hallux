...
Benchee.run(
  %{
    "insert" => fn {interval_map, n} ->
      IntervalMap.insert(interval_map, make_low_high_pair.(n))
    end,
    "interval_search" => fn {interval_map, n} ->
      IntervalMap.interval_search(interval_map, make_low_high_pair.(n))
    end,
    "interval_match" => fn {interval_map, n} ->
      IntervalMap.interval_match(interval_map, make_low_high_pair.(n))
    end
  },
  inputs: inputs,
  unit_scaling: :none
